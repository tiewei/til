...
func (*AWSCognitoUserPool) Manifests(id string, config, eventDst cty.Value, glb globals.Accessor) []interface{} {
	...
	s := k8s.NewObject(k8s.APISources, "AWSCognitoUserPoolSource", name)
