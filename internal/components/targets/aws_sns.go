...
func (*AWSSNS) Manifests(id string, config, eventDst cty.Value, _ globals.Accessor) []interface{} {
...
func (*AWSSNS) Address(id string, _, eventDst cty.Value, _ globals.Accessor) cty.Value {
	name := k8s.RFC1123Name(id)
